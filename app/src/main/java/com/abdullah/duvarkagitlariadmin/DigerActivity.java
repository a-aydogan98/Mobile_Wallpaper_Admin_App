...
public class DigerActivity extends AppCompatActivity {
    ...
    private void uploadImage() {
        ...
        if (filePath != null) {
            ...
            final StorageReference ref = storageReference.child("Diger/" + UUID.randomUUID().toString());
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            reference = FirebaseDatabase.getInstance().getReference("Diger/" + UUID.randomUUID()).child("url");
                    ...
                    Toast.makeText(DigerActivity.this, "Resim yüklendi.", Toast.LENGTH_SHORT).show();
                }
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(DigerActivity.this, "Başarısız!" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
